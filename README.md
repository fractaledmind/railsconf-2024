...
The workshop will follow a sequential series of steps. Each step will have instructions for you to follow. The instructions will be in the form of a markdown file in the `workshop` directory. If you have any questions while working through a step, please raise your hand and speak up. I am here to help you. Each step will take approximately 10 minutes to complete. If you finish early, please help your neighbor. After around 5 minutes, I will begin live-coding my implementation of the step. You can follow along with me or continue working on your own implementation. If you have any questions, please ask them at any time.

If you don't finish a step, that is fine. You can simply jump forward to the next commit as detailed at the end of that step's instructions and start the next step.

The first step in the workshop is to run some initial load tests to see how the app performs under load. You will find that step's instructions when you checkout the `step-1` tag.

```sh
git checkout step-1
```

and then open the `workshop/01-run-baseline-load-tests.md` file to begin.
